...
interface StaticPressureCalculatorModalContentProps {
  initialAirVolumeCmh: string;
  onClose: () => void;
  onApply: (value: number, unit: string) => void;
}
...
function StaticPressureCalculatorModalContent({
  initialAirVolumeCmh,
  onClose,
  onApply,
}: StaticPressureCalculatorModalContentProps) {
...
export default function StaticPressureCalculatorModal({
  ...
  return (
    ...
    >
      <StaticPressureCalculatorModalContent
        initialAirVolumeCmh={initialAirVolumeCmh}
        onClose={onClose}
        onApply={onApply}
      />
    </Modal>
